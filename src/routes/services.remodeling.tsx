...
export const Route = createFileRoute("/services/remodeling")({
  head: () => ({
    title: "Professional Remodeling Services – Kitchen, Bathroom & Home Renovations | Arizona Premiere Construction Group",
    meta: [
      { name: "description", content: "Licensed remodeling contractor in Chandler, AZ. Kitchen remodeling, bathroom renovations, whole home makeovers & more. ROC #328501. Free video consult & financing available. Call (602) 816 8177." },
    ],
  }),
    ...
    <main className="bg-[#F8FAFC] overflow-x-hidden">
        ...
        <div className={`relative z-10 max-w-5xl mx-auto px-4 transition-all duration-1000 transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 p-8 md:p-16 rounded-[2rem] shadow-2xl text-center">
            <div className="inline-flex items-center gap-2 bg-brand-orange/20 border border-brand-orange/30 px-4 py-2 rounded-full mb-8">
              ...
              <span className="text-brand-orange text-xs font-bold uppercase tracking-widest">Premium Arizona Transformations</span>
            </div>
            
            <h1 className="text-[35px] font-black text-white mb-6 leading-tight uppercase tracking-tight">
              Transform Your Space. Transform Your Life. — <span className="text-brand-orange">Arizona Remodeling</span> Experts
            </h1>
            
            <p className="text-white/80 text-lg md:text-xl max-w-3xl mx-auto mb-10 leading-relaxed font-medium">
              From outdated kitchens and cramped bathrooms to complete home transformations, Arizona Premiere Construction Group delivers licensed, insured, and bonded remodeling across the Valley. <span className="text-white font-bold">ROC #328501</span>.
            </p>
      ...
      <section className="py-[100px] px-4 md:px-8 mx-[15px] mt-[15px] rounded-[20px] bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20 relative z-10">
          ...
          <div className="lg:w-1/2">
            <span className="text-brand-orange font-bold tracking-widest uppercase text-sm mb-4 block">Remodeling That Respects Your Home</span>
            <h2 className="text-4xl md:text-6xl font-black text-[#1E110A] mb-8 leading-tight">
              Remodeling That Respects Your Home — <span className="text-brand-blue-deep underline decoration-brand-orange underline-offset-8">And Your Budget</span>
            </h2>
            <div className="space-y-6 text-gray-600 text-lg md:text-xl leading-relaxed">
              <p>
                Your home should grow with you. Whether you're dreaming of a chef-inspired kitchen, a spa-like bathroom, or a whole-home renovation, Arizona Premiere Construction Group brings over six years of local experience to every remodel. We are fully licensed (ROC #328501), insured, and bonded — so your home and investment are protected.
              </p>
              <p className="font-bold text-[#0A2B63]">
                We don't just renovate. We coordinate every detail: demolition, framing, drywall, flooring, painting, roofing, and electrical & plumbing coordination. One team. One vision. Zero headaches.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-[100px] px-4 md:px-8">
        <div className="max-w-7xl mx-auto text-center mb-20">
          <span className="text-brand-orange font-bold tracking-widest uppercase text-xs mb-4 block">What We Transform</span>
          <h2 className="text-4xl md:text-6xl font-black text-[#1E110A] mb-6">Expertise in Every Room</h2>
          <p className="text-gray-500 max-w-2xl mx-auto text-lg font-medium">Specialized remodeling teams for every corner of your home.</p>
        </div>
          ...
          {[
            ...
            <div key={i} className="group relative overflow-hidden rounded-[2rem] bg-white shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-100">
              ...
              <div className="p-10">
                ...
                <Link 
                  to={["Interior & Exterior Painting", "Flooring Installation", "Roofing Services"].includes(item.title) ? "/services/specialty-trade" : "/contact"} 
      ...
      <section className="py-[100px] px-4 md:px-8 mx-[15px] mt-[15px] rounded-[20px] bg-[#0A2B63] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col lg:flex-row justify-between items-end mb-20 gap-8">
            <div className="text-left">
              <span className="text-brand-orange font-bold tracking-widest uppercase text-xs mb-4 block">Full Service Coordination</span>
              <h2 className="text-4xl md:text-6xl font-black text-white mb-6">Every Detail, One Team</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="group bg-white/5 backdrop-blur-sm border border-white/10 p-8 rounded-[2rem] hover:bg-white hover:text-[#0A2B63] transition-all duration-500 cursor-default">
                ...
                <p className="text-xs opacity-60 group-hover:opacity-80 font-bold uppercase tracking-widest">Expert Execution</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-[100px] px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <span className="text-brand-orange font-bold tracking-widest uppercase text-xs mb-4 block">Trust & Transparency</span>
            <h2 className="text-4xl md:text-6xl font-black text-[#1E110A] mb-6">Why Homeowners Trust Us</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: "Licensed, Insured & Bonded", desc: "ROC #328501 – Full legal and financial protection for your remodel.", icon: <Shield /> },
              { title: "6+ Years Local Experience", desc: "We know Arizona homes, codes, and the unique desert climate needs.", icon: <Clock /> },
              { title: "Single Point of Contact", desc: "We manage all trades – no vendor chaos or communication gaps.", icon: <Users /> },
              { title: "Video Meetings & File Uploads", desc: "Approve designs, materials, and track progress remotely from anywhere.", icon: <Video /> },
              { title: "Financing Available", desc: "Flexible options for kitchen, bath, and whole-home remodels.", icon: <CreditCard /> },
              { title: "AI-Assisted Estimating", desc: "Precision quotes with zero hidden fees or surprise costs.", icon: <Search /> }
            ].map((benefit, i) => (
      ...
      <section className="py-[100px] px-4 md:px-8 mx-[15px] mt-[15px] rounded-[20px] bg-white border border-gray-100 relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-6xl font-black text-[#1E110A] mb-6">Simple, Stress‑Free Remodeling</h2>
      ...
      <section className="py-[100px] px-4 md:px-8 bg-[#0A2B63] text-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-brand-orange font-bold tracking-widest uppercase text-xs mb-4 block">Our Work</span>
            <h2 className="text-4xl md:text-5xl font-black mb-4">Real Results. Real Homes.</h2>
            <p className="text-white/60 font-medium">Browse our recent kitchen, bathroom, and whole-home transformations.</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {[1, 2, 3, 4, 5, 6].map((idx) => (
              <div key={idx} className="group relative aspect-video overflow-hidden rounded-[2rem] bg-white/5 border border-white/10 hover:border-brand-orange transition-all cursor-pointer">
                <img src={`/g${(idx % 4) + 1}.jpg`} alt={`Project ${idx}`} className="w-full h-full object-cover opacity-60 group-hover:opacity-100 transition-opacity" />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0A2B63] to-transparent opacity-0 group-hover:opacity-60 transition-opacity" />
                <div className="absolute bottom-6 left-6 opacity-0 group-hover:opacity-100 transition-all translate-y-4 group-hover:translate-y-0">
                  <span className="text-xs font-bold uppercase tracking-widest text-brand-orange mb-1 block">Remodel Project</span>
          ...
          <div className="text-center">
            <button className="inline-flex items-center gap-3 bg-white text-[#0A2B63] px-10 py-5 rounded-full font-black text-lg hover:bg-brand-orange hover:text-white transition-all shadow-xl shadow-white/5">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {["Phoenix", "Scottsdale", "Mesa", "Chandler", "Glendale", "Tempe", "Gilbert"].map((city, i) => (
              <div key={i} className="flex items-center gap-3 bg-gray-50 px-8 py-5 rounded-3xl border border-gray-100 hover:border-brand-orange transition-all group cursor-default">
                <div className="w-2 h-2 bg-brand-orange rounded-full group-hover:scale-150 transition-transform" />
                <span className="text-[#0A2B63] font-black text-lg">{city}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-[100px] px-4 md:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 font-medium">Get clear answers to common remodeling queries.</p>
          </div>

          <Accordion.Root type="single" collapsible className="space-y-4">
            {[
              { q: "Do I need a permit for my remodel?", a: "In most cases, yes. We handle all necessary permits for kitchen, bathroom, and structural remodels. ROC #328501 ensures full compliance." },
              { q: "How long does a kitchen remodel take?", a: "Typically 4–8 weeks depending on scope. We provide a clear timeline before any work begins." },
              { q: "Can I live in my home during the remodel?", a: "Yes, for most projects. We work cleanly and contain dust to designated areas. For whole-home remodels, we can discuss temporary relocation options." },
              { q: "Do you offer financing?", a: "Yes. Ask us about flexible financing options for kitchen, bathroom, and whole-home remodels." },
              { q: "Can I see my project progress without being there?", a: "Absolutely. We offer video meetings, photo updates, and live walkthroughs." },
              { q: "How do you handle electrical and plumbing during a remodel?", a: "We coordinate directly with licensed, vetted subcontractors – you work only with us." },
              { q: "Where do you source materials?", a: "We partner with trusted suppliers and provide backlinks for full material transparency." }
            ].map((item, i) => (
      ...
      <section className="py-[100px] px-4 md:px-8 mx-[15px] mb-[15px] rounded-[20px] bg-white border border-gray-100 shadow-2xl relative overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-20">
          <div className="lg:w-1/2">
            <span className="text-brand-orange font-bold tracking-widest uppercase text-xs mb-4 block">Start Your Transformation</span>
            <h2 className="text-4xl md:text-6xl font-black text-[#1E110A] mb-8 leading-tight">
              Start Your <span className="text-brand-orange">Remodeling</span> Project Today
            </h2>
            <p className="text-gray-600 text-lg mb-10 leading-relaxed">
              Fill out the form below to initiate your project. Whether you have detailed plans or just a dream, our team is ready to deliver a premium estimate within 24 hours.
            </p>
          ...
          <div className="lg:w-1/2">
            <form className="bg-gray-50 p-8 md:p-12 rounded-[3rem] border border-gray-100 shadow-inner grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2 md:col-span-2">
                <label className="text-xs font-black uppercase tracking-widest text-gray-400 ml-4">Remodel Type</label>
