    ...
    <main className="bg-[#F8FAFC] overflow-x-hidden">
        ...
        <div className={`relative z-10 max-w-5xl mx-auto px-4 transition-all duration-1000 transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 p-8 md:p-16 rounded-[2rem] shadow-2xl text-center">
            <div className="inline-flex items-center gap-2 bg-brand-orange/20 border border-brand-orange/30 px-4 py-2 rounded-full mb-8">
              ...
              <span className="text-brand-orange text-xs font-bold uppercase tracking-widest">Premium Arizona Builds</span>
            </div>
            
            <h1 className="text-[35px] font-black text-white mb-6 leading-tight uppercase tracking-tight">
              Built Right. Built Here. — <span className="text-brand-orange">Arizona's Trusted</span> Construction Partner
            </h1>
            
            <p className="text-white/80 text-lg md:text-xl max-w-3xl mx-auto mb-10 leading-relaxed font-medium">
              From ground-up new construction to commercial build-outs, Arizona Premiere Construction Group delivers licensed, insured, and bonded craftsmanship across the Valley. <span className="text-white font-bold">ROC #328501</span>.
            </p>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20 relative z-10">
          <div className="lg:w-1/2 relative">
            ...
            <div className="absolute -top-10 -right-10 bg-[#0A2B63] p-8 rounded-3xl text-white shadow-2xl hidden md:block animate-bounce-slow">
              ...
              <span className="text-xs opacity-60 uppercase font-bold tracking-widest">Years Experience</span>
            </div>
            ...
            <div className="absolute -bottom-10 -left-10 bg-white/80 backdrop-blur-md border border-gray-100 p-8 rounded-3xl shadow-xl hidden md:block">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <span className="text-2xl font-black text-[#0A2B63] block">500+</span>
          ...
          <div className="lg:w-1/2">
            <span className="text-brand-orange font-bold tracking-widest uppercase text-sm mb-4 block">Proven Excellence</span>
            <h2 className="text-4xl md:text-6xl font-black text-[#1E110A] mb-8 leading-tight">
              Construction Services You Can <span className="text-brand-blue-deep underline decoration-brand-orange underline-offset-8">Build On</span>
            </h2>
            <p className="text-gray-600 text-lg md:text-xl mb-10 leading-relaxed">
              At Arizona Premiere Construction Group, we believe that <span className="text-[#0A2B63] font-bold">transparency and precision</span> are the cornerstones of a successful build. Our master builders and project managers work as a cohesive unit to transform architectural blueprints into living, breathing structures.
            </p>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              {[
                { icon: <Ruler />, title: "Precision Planning", desc: "Digital modeling and architectural alignment." },
                { icon: <HardHat />, title: "Master Craftsmanship", desc: "Expert crews for every specific trade." },
                { icon: <ClipboardCheck />, title: "Permit Handling", desc: "We manage all city and valley approvals." },
                { icon: <Clock />, title: "On-Time Delivery", desc: "Rigid scheduling and milestone management." }
              ].map((item, i) => (
                <div key={i} className="flex items-start gap-4 p-4 rounded-2xl hover:bg-gray-50 transition-colors group">
                  <div className="bg-brand-blue-deep/5 p-3 rounded-xl group-hover:bg-brand-orange/10 transition-colors">
                    {React.cloneElement(item.icon as React.ReactElement, { className: "w-6 h-6 text-brand-blue-deep group-hover:text-brand-orange transition-colors" })}
                  </div>
                  <div>
                    <h4 className="font-extrabold text-[#0A2B63] mb-1">{item.title}</h4>
      ...
      <section className="py-[100px] px-4 md:px-8">
        <div className="max-w-7xl mx-auto text-center mb-20">
          <span className="text-brand-orange font-bold tracking-widest uppercase text-xs mb-4 block">Our Portfolio</span>
          <h2 className="text-4xl md:text-6xl font-black text-[#1E110A] mb-6">What We Build</h2>
          <p className="text-gray-500 max-w-2xl mx-auto text-lg font-medium">Premium service cards engineered for clarity and conversion.</p>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            { 
              ...
              desc: "Ground-up development for residential and commercial properties across the Valley.", 
              icon: <Construction />,
              image: "/service-3.jpg"
            },
            { 
          ...
          <div className="flex flex-col lg:flex-row justify-between items-end mb-20 gap-8">
            ...
            <div className="bg-white/10 backdrop-blur-md p-6 rounded-3xl border border-white/20 text-white max-w-sm">
              <p className="text-sm italic opacity-80 leading-relaxed">
                "Our single-point-of-contact model eliminates communication gaps between specialized trades."
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div key={i} className="group bg-white/5 backdrop-blur-sm border border-white/10 p-8 rounded-[2rem] hover:bg-white hover:text-[#0A2B63] transition-all duration-500 cursor-default">
                ...
                <p className="text-xs opacity-60 group-hover:opacity-80 font-bold uppercase tracking-widest">Licensed Professional</p>
              </div>
            ))}
          </div>
      ...
      <section className="py-[100px] px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <span className="text-brand-orange font-bold tracking-widest uppercase text-xs mb-4 block">The Premiere Advantage</span>
            <h2 className="text-4xl md:text-6xl font-black text-[#1E110A] mb-6">Why Arizona Premiere</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: "Licensed, Insured & Bonded", desc: "Total security for your investment with ROC #328501.", icon: <Shield /> },
              { title: "20+ Years Local Experience", desc: "Deep knowledge of Arizona soil, climate, and building codes.", icon: <Clock /> },
              { title: "Single Point of Contact", desc: "No middle-man confusion. Direct access to your project lead.", icon: <Users /> },
              { title: "Video Meetings & File Uploads", desc: "Modern transparency with real-time digital project tracking.", icon: <Video /> },
              { title: "Financing Available", desc: "Flexible payment plans to get your project started today.", icon: <CreditCard /> },
              { title: "AI-Assisted Estimating", desc: "Precision quotes with zero hidden fees using advanced tech.", icon: <Search /> }
            ].map((benefit, i) => (
          ...
          {/* Stats Counters */}
          <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 bg-[#0A2B63] p-12 rounded-[3rem] text-white">
            <div className="text-center border-r border-white/10 last:border-0">
              ...
              <span className="text-xs opacity-60 uppercase font-bold tracking-widest">Code Compliant</span>
            </div>
            <div className="text-center border-r border-white/10 last:border-0">
              <span className="text-4xl md:text-5xl font-black block mb-2">602</span>
              <span className="text-xs opacity-60 uppercase font-bold tracking-widest">Local Area Code</span>
            </div>
            <div className="text-center border-r border-white/10 last:border-0">
              <span className="text-4xl md:text-5xl font-black block mb-2">24h</span>
              <span className="text-xs opacity-60 uppercase font-bold tracking-widest">Response Time</span>
            </div>
            <div className="text-center last:border-0">
              <span className="text-4xl md:text-5xl font-black block mb-2">ROC</span>
              <span className="text-xs opacity-60 uppercase font-bold tracking-widest">#328501</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-[100px] px-4 md:px-8 mx-[15px] mt-[15px] rounded-[20px] bg-white border border-gray-100 relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-6xl font-black text-[#1E110A] mb-6">Simple, Stress-Free Construction</h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-lg font-medium">Our modern animated 3-step timeline for total project clarity.</p>
          </div>
      ...
      <section className="py-[100px] px-4 md:px-8 mx-[15px] mt-[15px] rounded-[20px] bg-[#0A2B63] relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-1/4 left-1/4 animate-pulse"><MapPin className="w-12 h-12 text-brand-orange" /></div>
          <div className="absolute top-1/2 left-1/3 animate-bounce-slow"><MapPin className="w-8 h-8 text-white" /></div>
          <div className="absolute bottom-1/4 right-1/4 animate-pulse"><MapPin className="w-10 h-10 text-brand-orange" /></div>
        </div>

        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 text-left">
              <span className="text-brand-orange font-bold tracking-widest uppercase text-xs mb-4 block">Regional Coverage</span>
              <h2 className="text-4xl md:text-6xl font-black text-white mb-6">We Build Across the Valley</h2>
              <p className="text-white/70 text-lg mb-10 leading-relaxed max-w-xl">
                From the bustling streets of Phoenix to the serene estates of Scottsdale, our crews are strategically deployed across the entire Phoenix metropolitan area.
              </p>
              <div className="grid grid-cols-2 gap-4">
                {["Phoenix", "Scottsdale", "Mesa", "Chandler", "Glendale", "Tempe", "Gilbert"].map((city, i) => (
                  <div key={i} className="flex items-center gap-3 bg-white/10 p-4 rounded-2xl border border-white/10 hover:bg-white/20 transition-all cursor-default">
            ...
            <div className="lg:w-1/2 relative">
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-4 rounded-[3rem] shadow-2xl relative">
                <img src="/g3.jpg" alt="Arizona architecture" className="rounded-[2.5rem] w-full h-[500px] object-cover" />
                ...
                <div className="absolute bottom-12 left-12 bg-white p-6 rounded-2xl shadow-xl">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <span className="text-[#0A2B63] font-black block">Valley Wide</span>
                      <span className="text-xs text-gray-500 font-bold uppercase tracking-widest">Rapid Mobilization</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-[100px] px-4 md:px-8 bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 font-medium">Get clear answers to common construction queries.</p>
          </div>

          <Accordion.Root type="single" collapsible className="space-y-4">
            {[
              { q: "Are you fully licensed for construction in Arizona?", a: "Yes, we are a fully licensed general contractor with the Arizona Registrar of Contractors (ROC #328501). We are also fully insured and bonded for your protection." },
              { q: "Do you handle both residential and commercial projects?", a: "Absolutely. Our teams are equipped for everything from ground-up residential luxury builds to complex commercial tenant improvements and retail shells." },
              { q: "How do you handle project updates and communication?", a: "We provide real-time digital project updates, including photos and milestone reports. You will also have a single point of contact available via video call or direct messaging." },
              { q: "Is financing available for large construction projects?", a: "Yes, we offer flexible financing options to help you manage the investment of a major build or remodel. Ask us about our current financing packages." },
              { q: "Do you manage electrical and plumbing coordination?", a: "We manage every phase of the project. Our team includes master-level trades for electrical, plumbing, and HVAC, ensuring all systems are integrated perfectly." },
              { q: "Is material sourcing transparent?", a: "Total transparency is our standard. We provide detailed material lists and handle all sourcing from premium suppliers, with zero hidden markups or surprise fees." }
            ].map((item, i) => (
      ...
      <section className="py-[100px] px-4 md:px-8 mx-[15px] mb-[15px] rounded-[20px] bg-white border border-gray-100 shadow-2xl relative overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-20">
          <div className="lg:w-1/2">
            <span className="text-brand-orange font-bold tracking-widest uppercase text-xs mb-4 block">Ready to Begin?</span>
            <h2 className="text-4xl md:text-6xl font-black text-[#1E110A] mb-8 leading-tight">
              Start Your <span className="text-brand-orange">Construction</span> Project Today
            </h2>
            <p className="text-gray-600 text-lg mb-10 leading-relaxed">
              Fill out the form below to initiate your project. Whether you have blueprints ready or just a vision, our team is ready to deliver a premium estimate within 24 hours.
            </p>
            ...
            <div className="bg-[#0A2B63] p-10 rounded-[3rem] text-white relative overflow-hidden">
              ...
              <div className="absolute top-0 right-0 p-10 opacity-10"><Construction className="w-48 h-48" /></div>
            </div>
          </div>
          ...
          <div className="lg:w-1/2">
            <form className="bg-gray-50 p-8 md:p-12 rounded-[3rem] border border-gray-100 shadow-inner grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2 md:col-span-2">
                <label className="text-xs font-black uppercase tracking-widest text-gray-400 ml-4">Project Address</label>
                <input type="text" placeholder="123 Arizona Way, Chandler, AZ" className="w-full bg-white border-transparent focus:border-brand-orange focus:ring-4 focus:ring-brand-orange/10 rounded-2xl px-6 py-4 font-bold text-[#0A2B63] transition-all outline-none" />
              </div>
              ...
              <div className="md:col-span-2 space-y-4 pt-4">
                <label className="flex items-center gap-4 cursor-pointer group">
                  ...
                  <span className="text-sm font-bold text-gray-600 group-hover:text-[#0A2B63] transition-colors">I am interested in project financing options</span>
                </label>
                <label className="flex items-center gap-4 cursor-pointer group">
                  <div className="relative">
                    <input type="checkbox" className="sr-only peer" />
                  ...
                  <span className="text-sm font-bold text-gray-600 group-hover:text-[#0A2B63] transition-colors">Send me information about preferred material suppliers</span>
                </label>
              </div>
